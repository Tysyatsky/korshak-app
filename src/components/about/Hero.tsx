...
import { Stack, Group, Title, Text, Anchor, Image, Tooltip } from '@mantine/core';
  ...
  return (
    <section className={styles.hero}>
      <div className={styles.heroGrid}>
        ...
        <Stack className={styles.colLeft} justify="space-between" gap={0}>
          <Title order={1} className={styles.heading}>
            Коршак Наталія<br />УЗД судин<br />м. Рівне
          </Title>
        ...
        <div className={styles.colCenter}>
          <Image src="/images/doctor-portrait.jpg" alt="Коршак Наталія" className={styles.heroImage} />
        </div>

        <Stack className={styles.colRight} justify="space-between" gap={0}>
          <Group className={styles.nav} justify="space-between" align="flex-start" gap={24}>
            <Stack gap={6}>
            ...
            <Tooltip label="прогорт до послуг" position="right">
              <a href="#posluhy" className={styles.ctaButton}>До послуг ↓</a>
            </Tooltip>
          </Group>
